...
namespace Challenge.Leet.Twenty.October.AsteroidCollision
{
    public class Test
    {
        ...
        public void CheckWithoutStack(int[] asteroids, int[] expectedOutput)
        {
            var timer = Stopwatch.StartNew();
            var solution = new Solution();
            timer.Start();
            var actualOutput = solution.AsteroidCollisionWithoutStack(asteroids);
            timer.Stop();
        ...
        [Theory]
        [MemberData(nameof(InputAndOutput))]
        public void CheckStack(int[] asteroids, int[] expectedOutput)
        {
            var timer = Stopwatch.StartNew();
            var solution = new Solution();
            timer.Start();
